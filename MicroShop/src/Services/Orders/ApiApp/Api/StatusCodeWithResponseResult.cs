...
namespace MicroShop.Services.Orders.ApiApp.Api;

public sealed class StatusCodeWithResponseResult<T>(HttpStatusCode statusCode, ResponseDto<T> value) : StatusCodeWithResponseResult(statusCode, value)
{
}
