...
using MicroShop.Services.ShoppingCart.App.Infrastructure.Auth;
using MicroShop.Services.ShoppingCart.App.Infrastructure.Data;
using MicroShop.Services.ShoppingCart.App.Models;
using MicroShop.Services.ShoppingCart.App.Services;
...
internal static class WebApplicationBuilderExtensions
{
    public static WebApplicationBuilder Configure(this WebApplicationBuilder builder)
    {
        ...
        services
            ...
            .Configure<RabbitQueue>("EmailShoppingCart", configuration.GetSection("RabbintMessaging:Queues:EmailShoppingCart"))
