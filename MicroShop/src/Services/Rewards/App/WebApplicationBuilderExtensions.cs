...
using MicroShop.Services.Rewards.App.Infrastructure.Data;
using MicroShop.Services.Rewards.App.Services;
...
namespace MicroShop.Services.Rewards.App;
...
internal static class WebApplicationBuilderExtensions
{
    public static WebApplicationBuilder Configure(this WebApplicationBuilder builder)
    {
        ...
        services.AddTopicConsumer<SubscriptionHandler>(configuration);
